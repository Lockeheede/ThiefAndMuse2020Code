...
namespace ThiefAndMuses2020Code.Weapons.Modern
{
    public class TwentyShot
    {
        ...
        public TwentyShot(int armorRating, int weaponRating, int magickRating, int weaponDamage, int weaponDefense, int magickDamage, int magickDefense, int weaponSpeed)
        {
